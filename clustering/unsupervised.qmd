...
The following code is based on [GitHub](https://github.com/ageron/handson-ml3/blob/main/09_unsupervised_learning.ipynb) the accompanying repository to @Geron2022-xh.
...
for colours in [8, 4, 2]:
    kmeans = KMeans(n_clusters=colours, n_init=10, random_state=6020).fit(X)
    plt.figure()

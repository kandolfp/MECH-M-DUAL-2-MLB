...
The basis of the algorithm is the so called _expectation-maximization_ (EM) algorithm of \cite{dempster1977maximum}, that is designed to find the _maximum-likelihood_ parameters of the defined statistical models.

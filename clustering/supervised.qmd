...
1. Additionally, for a higher dimensional problem, using LDA split the Fischer Iris dataset (@sec-fischer-iris-data-set) into two clusters. Try for the harder split between `versicolor` and `virginica` types of flowers.
::::
:::

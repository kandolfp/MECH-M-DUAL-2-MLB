...
plt.plot([-1, 1], [line(-1), line(1)], label="classification line")
plt.plot([-1, 1], [0.25, 0.25], ":", label="actual boundary line")
plt.gca().set_aspect(2/3.3)
plt.legend()
...
plt.plot([-1.6, 1.6], [line(-1.5), line(1.5)],
         label="scaled classification line")
...
b = composit_svm["standardscaler"].inverse_transform(
    [np.array([0, 1.6, line(1.6)])])[0]
plt.plot([a[1], b[1]], [a[2], b[2]], label="scaled classification line")

w = svm.coef_[0]
d = svm.intercept_[0]
plt.plot([-1, 1], [line(-1), line(1)], 
            ":", label="unscaled classification line")

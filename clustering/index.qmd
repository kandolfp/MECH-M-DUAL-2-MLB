...
plt.show()
```
As can be seen in the @fig-clustering-pca the first two components cover about `{python} float(np.round(q*100, 2))`% of the total variation in the samples and in accordance with this result a very good separation of the three species.

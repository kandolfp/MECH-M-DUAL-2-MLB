...
## Precision/Recall trade-off {#appendix-pvsr}

In @sec-clustering-sl-performance we discuss the performance topics and we cam across the precision/recall trade-off.

...
Furthermore, we also did not talk about how to persist the model we generated, after the program finished the model was gone again and needs to be retrained to further use it.
...
The intend is to see _it_ in action and to help understand the practical aspects of the challenges within these topics.
...
In addition, if we come to images, we could also see how changing the basis (_raw_ to _wavelet_) changed our results, see @sec-clustering-cvd.
...
Illustration of a common data engineering lifecycle in data processing. The _related topics_ are often referred as _undercurrents_.
::::

...
We will, in general, reference the documentation via `tensorflow`, the content on [keras.io Api Docs](https://keras.io/api/).
:::
...
model = tf.keras.Sequential([                                              # <1>
    ...
    tf.keras.layers.Dense(2, activation="softmax", name="H02")             # <4>
])                                                                         # <1>
...
1. Have a look at the possibilites provided in the framework [Overview - Optimizers](https://www.tensorflow.org/api_docs/python/tf/keras/optimizers) - they are basically all improvements on Stochastic Gradient Decent.

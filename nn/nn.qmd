...
$$
\begin{align}
\frac{\partial\, \mathscr{L}}{\partial\, a} &= \frac{\partial\, }{\partial\, a}\frac12 (y_0 - y)^2 = \frac{\partial\, }{\partial\, y}\frac12(y_0 - y)^2 \frac{\partial\, y}{\partial\, a} = \\ 
&= - \frac22 (y_0 - y) \frac{\partial\, y}{\partial\, a} = - (y_0 - y) \frac{\partial\, g(z, b)}{\partial\, a} = \\
&= - (y_0 - y) \frac{\partial\, g}{\partial\, z}\frac{\partial\, z}{\partial\, a} = - (y_0 - y) \frac{\partial\, g}{\partial\, z}\frac{\partial\, f(x, a)}{\partial\, a} = \\
&= - (y_0 - y) \frac{\partial\, g}{\partial\, z}\frac{\partial\, f}{\partial\, a}
\end{align}
$$
and 
$$
\begin{align}
\frac{\partial\, \mathscr{L}}{\partial\, b} &= \frac{\partial\, }{\partial\, b}\frac12 (y_0 - y)^2 = \\ 
&= - \frac22 (y_0 - y) \frac{\partial\, y}{\partial\, b} = - (y_0 - y) \frac{\partial\, g(z, b)}{\partial\, b} = \\
&= - (y_0 - y) \frac{\partial\, g}{\partial\, b},
\end{align}
$$
For a particular $g$ and $f$ we can compute it explicitly, e.g. $g(z,b) = b z$, and  $f(x,a) = \tanh(a x)$

$$
\begin{align}
\frac{\partial\, \mathscr{L}}{\partial\, a} &= - (y_0 - y) \frac{\partial\, g}{\partial\, z}\frac{\partial\, f}{\partial\, a} &=& - (y_0 - y) \cdot b \cdot x \cdot (1 - \tanh^2(a x)),\\
\frac{\partial\, \mathscr{L}}{\partial\, b} &= - (y_0 - y) \frac{\partial\, g}{\partial\, b} &=& - (y_0 - y) \cdot \tanh(a x).
\end{align}
$$
...
$$
\begin{align}
a^{(k+1)} &= a^{(k)} - \delta \frac{\partial\, \mathscr{L}}{\partial\, a},\\
b^{(k+1)} &= b^{(k)} - \delta \frac{\partial\, \mathscr{L}}{\partial\, b}.
\end{align}
$$
::::
:::
...
Overall we want to compute the change in the 
$$
\frac{\partial\, \mathscr{L}}{\partial \, B_{k,1}} = \frac{\partial\, \mathscr{L}}{\partial \, p} \cdot \frac{\partial\, p}{\partial \, z} \cdot \frac{\partial\, z}{\partial \, B_{k, 1}}
$$

1. Compute $\partial_{p_i} \mathscr{L}$.
1. The computation of the Jacobian of $\sigma(z)$ is tricky but together with the cross-entropy loss it is straight forward, therefore compute $\partial_{z} \mathscr{L}(\sigma(z))$.
1. Compute $\partial_{B_{k,1}} z$.
1. Write down the components showing up for the chain rule for $\frac{\partial\, \mathscr{L}}{\partial \, A_{k,1}}$ (similar as above).
::::
:::

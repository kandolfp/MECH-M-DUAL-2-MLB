...
Retrain the autoencoder with these training sets and see how it performs (can it handle all of them?).
::::
:::
...
If for the later tasks reworking the model such that the laten space is smaller is beneficial, feel free to do so.

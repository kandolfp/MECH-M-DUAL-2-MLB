...
Autoencoders can be seen as a generalization of linear subspace embedding of _singular value decomposition_/_principal component analysis_[^1] to a nonlinear manifold embedding.
